  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-slate-200 dark:border-slate-800 shadow-xs">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-semibold text-slate-500">Rata-Rata Skor Sinergi</span>
          ...
          <p className="text-[11px] text-amber-600 font-semibold mt-1">
            Tingkat saling gotong royong tinggi
          </p>
        </div>
      ...
      {/* Main Section: Distribution Charts */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left: 11 Social Media Accounts Adoption Trend */}
        ...
        {/* Right: Occupation Breakdown Trend */}
        <div className="lg:col-span-5 bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-xs space-y-4">
          <div>
            <h3 className="text-base font-black text-slate-900 dark:text-white flex items-center gap-2">
              ...
              <span>Tren Bidang Pekerjaan Anggota</span>
            </h3>
            <p className="text-xs text-slate-500 mt-0.5">
              Diambil dari input <em>&ldquo;Pekerjaan Anda&rdquo;</em> pada form registrasi.
            </p>
          </div>

          <div className="space-y-3 pt-2">
            {occupationStats.map((occ) => (
              <div
                key={occ.occupation}
              ...
              >
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">
                    {occ.count} anggota terdaftar
                  </p>
                </div>
                <span className="px-2.5 py-1 rounded-full bg-amber-100 dark:bg-amber-950/60 text-amber-800 dark:text-amber-300 font-black text-xs">
                  {occ.percent}%
                </span>
              </div>
            ))}
          ...
          {/* Quick Notice */}
          <div className="p-3.5 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 text-xs text-emerald-900 dark:text-emerald-200 leading-relaxed">
            💡 <strong>Rekomendasi Sinergi:</strong> Sebagian besar anggota berprofesi sebagai{' '}
            <strong>{occupationStats[0]?.occupation || 'Wiraswasta'}</strong>. Saling tukar review di Google Map dan postingan promosi sangat efektif mendongkrak penjualan!
          </div>
        </div>
      </div>
    </div>
